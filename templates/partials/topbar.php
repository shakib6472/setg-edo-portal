...
<header class="edo-topbar edo-topbar--desktop">
	<div class="edo-search" role="search">
		...
		<span><?php esc_html_e( 'Zoek opdrachten, trainingen…', 'setg-edo-portal' ); ?></span>
	</div>
	<div class="edo-topbar__actions">
		<button type="button" class="edo-iconbtn" aria-label="<?php esc_attr_e( 'Meldingen', 'setg-edo-portal' ); ?>">
		...
		<a href="<?php echo esc_url( edo_view_url( 'profile' ) ); ?>" class="edo-avatar edo-avatar--sm" aria-label="<?php esc_attr_e( 'Mijn profiel', 'setg-edo-portal' ); ?>">
...
<header class="edo-topbar edo-topbar--mobile">
	...
	<button type="button" class="edo-iconbtn edo-iconbtn--plain" aria-label="<?php esc_attr_e( 'Meldingen', 'setg-edo-portal' ); ?>">
